...
import { MessageSquare, Mic, ArrowLeft, Sparkles, Brain, FileText, Search } from 'lucide-react';
...
const Interview = () => {
  ...
  const handleTextChat = () => {
    ...
    navigate(`/text-interview?resumeId=${encoded}`);
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            ...
            <Card className="border-border/50 bg-card/50 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] group">
              <CardHeader className="text-center pb-4">
                ...
                <CardDescription className="text-muted-foreground">
                  Upload the respective target JD and find out the confidence level of your resume against the given JD.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2 text-sm text-muted-foreground">
                  <div className="flex items-center space-x-2">
                    ...
                    <span>Resume confidence level</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="h-1.5 w-1.5 bg-ai-cyan rounded-full" />
                    <span>Required Suggestions</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="h-1.5 w-1.5 bg-ai-cyan rounded-full" />
